...
- [Linux capabilities](../../../post_installation_configuration/day_2_core_cnf_clusters/security/security-host-sec.xml#security-linux-capabilities-overview_security-host-sec)
