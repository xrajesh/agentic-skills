...
- [Updating the worker nodes](../../../post_installation_configuration/day_2_core_cnf_clusters/updating/update-completing-the-control-plane-only-update.xml#update-updating-the-worker-nodes_completing-the-update)
...
- [Monitoring the cluster update](../../../post_installation_configuration/day_2_core_cnf_clusters/updating/update-completing-the-control-plane-only-update.xml#update-monitoring-the-cluster-update_completing-the-update)
...
- [Updating the OLM Operators](../../../post_installation_configuration/day_2_core_cnf_clusters/updating/update-completing-the-control-plane-only-update.xml#update-updating-the-olm-operators_completing-the-update)
