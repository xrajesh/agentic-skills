...
For information on how to convert your cluster, see the [Converting a connected cluster to a disconnected cluster](../disconnected/connected-to-disconnected.xml#converting-to-disconnected) procedure in the Disconnected environments section.
