...
- [Installing a user provisioned cluster on bare metal](../../installing/installing_bare_metal/upi/installing-bare-metal.xml#installing-bare-metal). You can then add 64-bit ARM compute machines to your OpenShift Container Platform cluster on bare metal.

- [Installing a cluster on IBM Power®](../../installing/installing_ibm_power/preparing-to-install-on-ibm-power.xml#preparing-to-install-on-ibm-power). You can then add `x86_64` compute machines to your OpenShift Container Platform cluster on IBM Power®.

- [Installing a cluster on IBM Z® and IBM® LinuxONE](../../installing/installing_ibm_z/preparing-to-install-on-ibm-z.xml#preparing-to-install-on-ibm-z). You can then add `x86_64` compute machines to your OpenShift Container Platform cluster on IBM Z® and IBM® LinuxONE.
