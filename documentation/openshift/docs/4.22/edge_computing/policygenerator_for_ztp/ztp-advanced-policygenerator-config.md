...
- [Using PolicyGenerator CRs to override source CRs content](../../edge_computing/policygenerator_for_ztp/ztp-advanced-policygenerator-config.xml#ztp-using-pgt-to-update-source-crs_ztp-advanced-policygenerator-config)
