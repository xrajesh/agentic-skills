...
| `data` | [`RawExtension`](../objects/index.xml#io-k8s-apimachinery-pkg-runtime-RawExtension) | Data is the serialized representation of the state. |
...
|----|----|
| 200 - OK | [`ControllerRevisionList`](../objects/index.xml#io-k8s-api-apps-v1-ControllerRevisionList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ControllerRevision`](../metadata_apis/controllerrevision-apps-v1.xml#controllerrevision-apps-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ControllerRevision`](../metadata_apis/controllerrevision-apps-v1.xml#controllerrevision-apps-v1) schema |
| 201 - Created | [`ControllerRevision`](../metadata_apis/controllerrevision-apps-v1.xml#controllerrevision-apps-v1) schema |
| 202 - Accepted | [`ControllerRevision`](../metadata_apis/controllerrevision-apps-v1.xml#controllerrevision-apps-v1) schema |
| 401 - Unauthorized | Empty |
