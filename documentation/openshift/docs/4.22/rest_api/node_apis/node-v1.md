...
| Parameter | Type                                              | Description |
|-----------|---------------------------------------------------|-------------|
| `body`    | [`Node`](../node_apis/node-v1.xml#node-v1) schema |             |

Body parameters

| HTTP code          | Reponse body                                      |
|--------------------|---------------------------------------------------|
| 200 - OK           | [`Node`](../node_apis/node-v1.xml#node-v1) schema |
| 201 - Created      | [`Node`](../node_apis/node-v1.xml#node-v1) schema |
| 202 - Accepted     | [`Node`](../node_apis/node-v1.xml#node-v1) schema |
| 401 - Unauthorized | Empty                                             |
