...
|----|----|
| 200 - OK | [`BareMetalHostList`](../objects/index.xml#io-metal3-v1alpha1-BareMetalHostList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`BareMetalHost`](../provisioning_apis/baremetalhost-metal3-io-v1alpha1.xml#baremetalhost-metal3-io-v1alpha1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`BareMetalHost`](../provisioning_apis/baremetalhost-metal3-io-v1alpha1.xml#baremetalhost-metal3-io-v1alpha1) schema |
| 201 - Created | [`BareMetalHost`](../provisioning_apis/baremetalhost-metal3-io-v1alpha1.xml#baremetalhost-metal3-io-v1alpha1) schema |
| 202 - Accepted | [`BareMetalHost`](../provisioning_apis/baremetalhost-metal3-io-v1alpha1.xml#baremetalhost-metal3-io-v1alpha1) schema |
| 401 - Unauthorized | Empty |
