...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OperatorList`](../objects/index.xml#com-coreos-operators-v1-OperatorList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Operator`](../operatorhub_apis/operator-operators-coreos-com-v1.xml#operator-operators-coreos-com-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Operator`](../operatorhub_apis/operator-operators-coreos-com-v1.xml#operator-operators-coreos-com-v1) schema |
| 201 - Created | [`Operator`](../operatorhub_apis/operator-operators-coreos-com-v1.xml#operator-operators-coreos-com-v1) schema |
| 202 - Accepted | [`Operator`](../operatorhub_apis/operator-operators-coreos-com-v1.xml#operator-operators-coreos-com-v1) schema |
| 401 - Unauthorized | Empty |
