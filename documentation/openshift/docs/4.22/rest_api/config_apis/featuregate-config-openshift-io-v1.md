...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`FeatureGateList`](../objects/index.xml#io-openshift-config-v1-FeatureGateList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`FeatureGate`](../config_apis/featuregate-config-openshift-io-v1.xml#featuregate-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`FeatureGate`](../config_apis/featuregate-config-openshift-io-v1.xml#featuregate-config-openshift-io-v1) schema |
| 201 - Created | [`FeatureGate`](../config_apis/featuregate-config-openshift-io-v1.xml#featuregate-config-openshift-io-v1) schema |
| 202 - Accepted | [`FeatureGate`](../config_apis/featuregate-config-openshift-io-v1.xml#featuregate-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
