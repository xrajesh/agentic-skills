...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterVersionList`](../objects/index.xml#io-openshift-config-v1-ClusterVersionList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ClusterVersion`](../config_apis/clusterversion-config-openshift-io-v1.xml#clusterversion-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterVersion`](../config_apis/clusterversion-config-openshift-io-v1.xml#clusterversion-config-openshift-io-v1) schema |
| 201 - Created | [`ClusterVersion`](../config_apis/clusterversion-config-openshift-io-v1.xml#clusterversion-config-openshift-io-v1) schema |
| 202 - Accepted | [`ClusterVersion`](../config_apis/clusterversion-config-openshift-io-v1.xml#clusterversion-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
