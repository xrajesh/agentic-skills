...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterOperatorList`](../objects/index.xml#io-openshift-config-v1-ClusterOperatorList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ClusterOperator`](../config_apis/clusteroperator-config-openshift-io-v1.xml#clusteroperator-config-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ClusterOperator`](../config_apis/clusteroperator-config-openshift-io-v1.xml#clusteroperator-config-openshift-io-v1) schema |
| 201 - Created | [`ClusterOperator`](../config_apis/clusteroperator-config-openshift-io-v1.xml#clusteroperator-config-openshift-io-v1) schema |
| 202 - Accepted | [`ClusterOperator`](../config_apis/clusteroperator-config-openshift-io-v1.xml#clusteroperator-config-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
