...
| `content` | [`RawExtension`](../objects/index.xml#io-k8s-apimachinery-pkg-runtime-RawExtension) | Content is the actual content of the request for create and update |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`LocalResourceAccessReview`](../authorization_apis/localresourceaccessreview-authorization-openshift-io-v1.xml#localresourceaccessreview-authorization-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`LocalResourceAccessReview`](../authorization_apis/localresourceaccessreview-authorization-openshift-io-v1.xml#localresourceaccessreview-authorization-openshift-io-v1) schema |
| 201 - Created | [`LocalResourceAccessReview`](../authorization_apis/localresourceaccessreview-authorization-openshift-io-v1.xml#localresourceaccessreview-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`LocalResourceAccessReview`](../authorization_apis/localresourceaccessreview-authorization-openshift-io-v1.xml#localresourceaccessreview-authorization-openshift-io-v1) schema |
