...
| `metadata` | [`ObjectMeta`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-ObjectMeta) | Standard list metadata. More info: <https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#metadata> |
...
|----|----|----|
| `rawSelector` | `string` | rawSelector is the serialization of a field selector that would be included in a query parameter. Webhook implementations are encouraged to ignore rawSelector. The kube-apiserver’s \*SubjectAccessReview will parse the rawSelector as long as the requirements are not present. |
| `requirements` | [`array (LabelSelectorRequirement)`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-LabelSelectorRequirement) | requirements is the parsed interpretation of a label selector. All requirements must be met for a resource instance to match the selector. Webhook implementations should handle requirements, but how to handle them is up to the webhook. Since requirements can only limit the request, it is safe to authorize as unlimited request if the requirements are not understood. |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-k8s-io-v1.xml#localsubjectaccessreview-authorization-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-k8s-io-v1.xml#localsubjectaccessreview-authorization-k8s-io-v1) schema |
| 201 - Created | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-k8s-io-v1.xml#localsubjectaccessreview-authorization-k8s-io-v1) schema |
| 202 - Accepted | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-k8s-io-v1.xml#localsubjectaccessreview-authorization-k8s-io-v1) schema |
