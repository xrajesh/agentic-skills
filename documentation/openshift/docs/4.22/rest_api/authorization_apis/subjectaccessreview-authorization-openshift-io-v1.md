...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`SubjectAccessReview`](../authorization_apis/subjectaccessreview-authorization-openshift-io-v1.xml#subjectaccessreview-authorization-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`SubjectAccessReview`](../authorization_apis/subjectaccessreview-authorization-openshift-io-v1.xml#subjectaccessreview-authorization-openshift-io-v1) schema |
| 201 - Created | [`SubjectAccessReview`](../authorization_apis/subjectaccessreview-authorization-openshift-io-v1.xml#subjectaccessreview-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`SubjectAccessReview`](../authorization_apis/subjectaccessreview-authorization-openshift-io-v1.xml#subjectaccessreview-authorization-openshift-io-v1) schema |
