...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`SelfSubjectRulesReview`](../authorization_apis/selfsubjectrulesreview-authorization-k8s-io-v1.xml#selfsubjectrulesreview-authorization-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`SelfSubjectRulesReview`](../authorization_apis/selfsubjectrulesreview-authorization-k8s-io-v1.xml#selfsubjectrulesreview-authorization-k8s-io-v1) schema |
| 201 - Created | [`SelfSubjectRulesReview`](../authorization_apis/selfsubjectrulesreview-authorization-k8s-io-v1.xml#selfsubjectrulesreview-authorization-k8s-io-v1) schema |
| 202 - Accepted | [`SelfSubjectRulesReview`](../authorization_apis/selfsubjectrulesreview-authorization-k8s-io-v1.xml#selfsubjectrulesreview-authorization-k8s-io-v1) schema |
