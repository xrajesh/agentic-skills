...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1.xml#localsubjectaccessreview-authorization-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1.xml#localsubjectaccessreview-authorization-openshift-io-v1) schema |
| 201 - Created | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1.xml#localsubjectaccessreview-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`LocalSubjectAccessReview`](../authorization_apis/localsubjectaccessreview-authorization-openshift-io-v1.xml#localsubjectaccessreview-authorization-openshift-io-v1) schema |
