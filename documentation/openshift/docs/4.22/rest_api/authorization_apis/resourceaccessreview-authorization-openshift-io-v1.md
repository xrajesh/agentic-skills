...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ResourceAccessReview`](../authorization_apis/resourceaccessreview-authorization-openshift-io-v1.xml#resourceaccessreview-authorization-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ResourceAccessReview`](../authorization_apis/resourceaccessreview-authorization-openshift-io-v1.xml#resourceaccessreview-authorization-openshift-io-v1) schema |
| 201 - Created | [`ResourceAccessReview`](../authorization_apis/resourceaccessreview-authorization-openshift-io-v1.xml#resourceaccessreview-authorization-openshift-io-v1) schema |
| 202 - Accepted | [`ResourceAccessReview`](../authorization_apis/resourceaccessreview-authorization-openshift-io-v1.xml#resourceaccessreview-authorization-openshift-io-v1) schema |
