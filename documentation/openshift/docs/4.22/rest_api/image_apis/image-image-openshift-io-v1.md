...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ImageList`](../objects/index.xml#com-github-openshift-api-image-v1-ImageList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`Image`](../image_apis/image-image-openshift-io-v1.xml#image-image-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`Image`](../image_apis/image-image-openshift-io-v1.xml#image-image-openshift-io-v1) schema |
| 201 - Created | [`Image`](../image_apis/image-image-openshift-io-v1.xml#image-image-openshift-io-v1) schema |
| 202 - Accepted | [`Image`](../image_apis/image-image-openshift-io-v1.xml#image-image-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
