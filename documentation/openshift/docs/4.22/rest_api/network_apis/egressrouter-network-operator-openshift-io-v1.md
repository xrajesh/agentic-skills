...
|----|----|
| 200 - OK | [`EgressRouterList`](../objects/index.xml#io-openshift-operator-network-v1-EgressRouterList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`EgressRouter`](../network_apis/egressrouter-network-operator-openshift-io-v1.xml#egressrouter-network-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`EgressRouter`](../network_apis/egressrouter-network-operator-openshift-io-v1.xml#egressrouter-network-operator-openshift-io-v1) schema |
| 201 - Created | [`EgressRouter`](../network_apis/egressrouter-network-operator-openshift-io-v1.xml#egressrouter-network-operator-openshift-io-v1) schema |
| 202 - Accepted | [`EgressRouter`](../network_apis/egressrouter-network-operator-openshift-io-v1.xml#egressrouter-network-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
