...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`EgressIPList`](../objects/index.xml#org-ovn-k8s-v1-EgressIPList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`EgressIP`](../network_apis/egressip-k8s-ovn-org-v1.xml#egressip-k8s-ovn-org-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`EgressIP`](../network_apis/egressip-k8s-ovn-org-v1.xml#egressip-k8s-ovn-org-v1) schema |
| 201 - Created | [`EgressIP`](../network_apis/egressip-k8s-ovn-org-v1.xml#egressip-k8s-ovn-org-v1) schema |
| 202 - Accepted | [`EgressIP`](../network_apis/egressip-k8s-ovn-org-v1.xml#egressip-k8s-ovn-org-v1) schema |
| 401 - Unauthorized | Empty |
