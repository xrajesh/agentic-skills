...
|----|----|
| 200 - OK | [`NetworkAttachmentDefinitionList`](../objects/index.xml#io-cncf-cni-k8s-v1-NetworkAttachmentDefinitionList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`NetworkAttachmentDefinition`](../network_apis/networkattachmentdefinition-k8s-cni-cncf-io-v1.xml#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`NetworkAttachmentDefinition`](../network_apis/networkattachmentdefinition-k8s-cni-cncf-io-v1.xml#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |
| 201 - Created | [`NetworkAttachmentDefinition`](../network_apis/networkattachmentdefinition-k8s-cni-cncf-io-v1.xml#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |
| 202 - Accepted | [`NetworkAttachmentDefinition`](../network_apis/networkattachmentdefinition-k8s-cni-cncf-io-v1.xml#networkattachmentdefinition-k8s-cni-cncf-io-v1) schema |
| 401 - Unauthorized | Empty |
