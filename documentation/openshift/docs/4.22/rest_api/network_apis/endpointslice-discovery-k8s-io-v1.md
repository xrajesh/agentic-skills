...
| `targetRef` | [`ObjectReference`](../objects/index.xml#io-k8s-api-core-v1-ObjectReference) | targetRef is a reference to a Kubernetes object that represents this endpoint. |
...
|----|----|
| 200 - OK | [`EndpointSliceList`](../objects/index.xml#io-k8s-api-discovery-v1-EndpointSliceList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`EndpointSlice`](../network_apis/endpointslice-discovery-k8s-io-v1.xml#endpointslice-discovery-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`EndpointSlice`](../network_apis/endpointslice-discovery-k8s-io-v1.xml#endpointslice-discovery-k8s-io-v1) schema |
| 201 - Created | [`EndpointSlice`](../network_apis/endpointslice-discovery-k8s-io-v1.xml#endpointslice-discovery-k8s-io-v1) schema |
| 202 - Accepted | [`EndpointSlice`](../network_apis/endpointslice-discovery-k8s-io-v1.xml#endpointslice-discovery-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |
