...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`KubeAPIServerList`](../objects/index.xml#io-openshift-operator-v1-KubeAPIServerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`KubeAPIServer`](../operator_apis/kubeapiserver-operator-openshift-io-v1.xml#kubeapiserver-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`KubeAPIServer`](../operator_apis/kubeapiserver-operator-openshift-io-v1.xml#kubeapiserver-operator-openshift-io-v1) schema |
| 201 - Created | [`KubeAPIServer`](../operator_apis/kubeapiserver-operator-openshift-io-v1.xml#kubeapiserver-operator-openshift-io-v1) schema |
| 202 - Accepted | [`KubeAPIServer`](../operator_apis/kubeapiserver-operator-openshift-io-v1.xml#kubeapiserver-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
