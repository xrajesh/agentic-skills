...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftAPIServerList`](../objects/index.xml#io-openshift-operator-v1-OpenShiftAPIServerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`OpenShiftAPIServer`](../operator_apis/openshiftapiserver-operator-openshift-io-v1.xml#openshiftapiserver-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftAPIServer`](../operator_apis/openshiftapiserver-operator-openshift-io-v1.xml#openshiftapiserver-operator-openshift-io-v1) schema |
| 201 - Created | [`OpenShiftAPIServer`](../operator_apis/openshiftapiserver-operator-openshift-io-v1.xml#openshiftapiserver-operator-openshift-io-v1) schema |
| 202 - Accepted | [`OpenShiftAPIServer`](../operator_apis/openshiftapiserver-operator-openshift-io-v1.xml#openshiftapiserver-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
