...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`KubeSchedulerList`](../objects/index.xml#io-openshift-operator-v1-KubeSchedulerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`KubeScheduler`](../operator_apis/kubescheduler-operator-openshift-io-v1.xml#kubescheduler-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`KubeScheduler`](../operator_apis/kubescheduler-operator-openshift-io-v1.xml#kubescheduler-operator-openshift-io-v1) schema |
| 201 - Created | [`KubeScheduler`](../operator_apis/kubescheduler-operator-openshift-io-v1.xml#kubescheduler-operator-openshift-io-v1) schema |
| 202 - Accepted | [`KubeScheduler`](../operator_apis/kubescheduler-operator-openshift-io-v1.xml#kubescheduler-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
