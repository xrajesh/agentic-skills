...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftControllerManagerList`](../objects/index.xml#io-openshift-operator-v1-OpenShiftControllerManagerList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`OpenShiftControllerManager`](../operator_apis/openshiftcontrollermanager-operator-openshift-io-v1.xml#openshiftcontrollermanager-operator-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`OpenShiftControllerManager`](../operator_apis/openshiftcontrollermanager-operator-openshift-io-v1.xml#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 201 - Created | [`OpenShiftControllerManager`](../operator_apis/openshiftcontrollermanager-operator-openshift-io-v1.xml#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 202 - Accepted | [`OpenShiftControllerManager`](../operator_apis/openshiftcontrollermanager-operator-openshift-io-v1.xml#openshiftcontrollermanager-operator-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
