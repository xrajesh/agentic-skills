...
| `metadata` | [`ObjectMeta`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-ObjectMeta) | Standard object’s metadata. metadata.name must be the Kubernetes node name. |
...
| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`CSINodeList`](../objects/index.xml#io-k8s-api-storage-v1-CSINodeList) schema |
| 401 - Unauthorized | Empty |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`CSINode`](../storage_apis/csinode-storage-k8s-io-v1.xml#csinode-storage-k8s-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`CSINode`](../storage_apis/csinode-storage-k8s-io-v1.xml#csinode-storage-k8s-io-v1) schema |
| 201 - Created | [`CSINode`](../storage_apis/csinode-storage-k8s-io-v1.xml#csinode-storage-k8s-io-v1) schema |
| 202 - Accepted | [`CSINode`](../storage_apis/csinode-storage-k8s-io-v1.xml#csinode-storage-k8s-io-v1) schema |
| 401 - Unauthorized | Empty |
