...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`PodSecurityPolicyReview`](../security_apis/podsecuritypolicyreview-security-openshift-io-v1.xml#podsecuritypolicyreview-security-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`PodSecurityPolicyReview`](../security_apis/podsecuritypolicyreview-security-openshift-io-v1.xml#podsecuritypolicyreview-security-openshift-io-v1) schema |
| 201 - Created | [`PodSecurityPolicyReview`](../security_apis/podsecuritypolicyreview-security-openshift-io-v1.xml#podsecuritypolicyreview-security-openshift-io-v1) schema |
| 202 - Accepted | [`PodSecurityPolicyReview`](../security_apis/podsecuritypolicyreview-security-openshift-io-v1.xml#podsecuritypolicyreview-security-openshift-io-v1) schema |
