...
|----|----|
| 200 - OK | [`StatefulSetList`](../objects/index.xml#io-k8s-api-apps-v1-StatefulSetList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`StatefulSet`](../workloads_apis/statefulset-apps-v1.xml#statefulset-apps-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`StatefulSet`](../workloads_apis/statefulset-apps-v1.xml#statefulset-apps-v1) schema |
| 201 - Created | [`StatefulSet`](../workloads_apis/statefulset-apps-v1.xml#statefulset-apps-v1) schema |
| 202 - Accepted | [`StatefulSet`](../workloads_apis/statefulset-apps-v1.xml#statefulset-apps-v1) schema |
| 401 - Unauthorized | Empty |
