...
|----|----|
| 200 - OK | [`ReplicationControllerList`](../objects/index.xml#io-k8s-api-core-v1-ReplicationControllerList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`ReplicationController`](../workloads_apis/replicationcontroller-v1.xml#replicationcontroller-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`ReplicationController`](../workloads_apis/replicationcontroller-v1.xml#replicationcontroller-v1) schema |
| 201 - Created | [`ReplicationController`](../workloads_apis/replicationcontroller-v1.xml#replicationcontroller-v1) schema |
| 202 - Accepted | [`ReplicationController`](../workloads_apis/replicationcontroller-v1.xml#replicationcontroller-v1) schema |
| 401 - Unauthorized | Empty |
