...
<td style="text-align: left;"><p><a href="../objects/index.xml#io-k8s-api-core-v1-ResourceRequirements_v3"><code>ResourceRequirements_v3</code></a></p></td>
...
| `pushSecret` | [`LocalObjectReference_v2`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference_v2) | PushSecret is the name of a Secret that would be used for setting up the authentication for executing the Docker push to authentication enabled Docker Registry (or Docker Hub). |
...
| `sourceSecret` | [`LocalObjectReference_v2`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference_v2) | sourceSecret is the name of a Secret that would be used for setting up the authentication for cloning private repository. The secret contains valid credentials for remote repository, where the data’s key represent the authentication method to be used and value is the base64 encoded credentials. Supported auth methods are: ssh-privatekey. |
...
| Property | Type | Description |
|----|----|----|
| `configMap` | [`LocalObjectReference_v2`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference_v2) | configMap is a reference to an existing configmap that you want to use in your build. |
...
| `pullSecret` | [`LocalObjectReference_v2`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference_v2) | pullSecret is a reference to a secret to be used to pull the image from a registry If the image is pulled from the OpenShift registry, this field does not need to be set. |
...
| `secret` | [`LocalObjectReference_v2`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference_v2) | secret is a reference to an existing secret that you want to use in your build. |
...
| `env` | [`array (EnvVar_v3)`](../objects/index.xml#io-k8s-api-core-v1-EnvVar_v3) | env contains additional environment variables you want to pass into a builder container. |
...
| `pullSecret` | [`LocalObjectReference_v2`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference_v2) | pullSecret is the name of a Secret that would be used for setting up the authentication for pulling the container images from the private Docker registries |
...
| `secretSource` | [`LocalObjectReference_v2`](../objects/index.xml#io-k8s-api-core-v1-LocalObjectReference_v2) | secretSource is a reference to the secret |
...
| Property | Type | Description |
|----|----|----|
| `env` | [`array (EnvVar_v3)`](../objects/index.xml#io-k8s-api-core-v1-EnvVar_v3) | env contains additional environment variables you want to pass into a build pipeline. |
...
| `lastTriggerTime` | [`Time`](../objects/index.xml#io-k8s-apimachinery-pkg-apis-meta-v1-Time) | lastTriggerTime is the last time this particular ImageStreamTag triggered a Build to start. This field is only updated when this trigger specifically started a Build. |
...
|----|----|
| 200 - OK | [`BuildConfigList`](../objects/index.xml#com-github-openshift-api-build-v1-BuildConfigList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`BuildConfig`](../workloads_apis/buildconfig-build-openshift-io-v1.xml#buildconfig-build-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`BuildConfig`](../workloads_apis/buildconfig-build-openshift-io-v1.xml#buildconfig-build-openshift-io-v1) schema |
| 201 - Created | [`BuildConfig`](../workloads_apis/buildconfig-build-openshift-io-v1.xml#buildconfig-build-openshift-io-v1) schema |
| 202 - Accepted | [`BuildConfig`](../workloads_apis/buildconfig-build-openshift-io-v1.xml#buildconfig-build-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
