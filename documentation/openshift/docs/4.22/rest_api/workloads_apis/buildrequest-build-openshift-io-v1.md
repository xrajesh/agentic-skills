...
| `from` | [`ObjectReference`](../objects/index.xml#io-k8s-api-core-v1-ObjectReference) | from is the reference to the ImageStreamTag that triggered the build. |
...
| `triggeredByImage` | [`ObjectReference`](../objects/index.xml#io-k8s-api-core-v1-ObjectReference) | triggeredByImage is the Image that triggered this build. |
...
| Property | Type | Description |
|----|----|----|
| `buildArgs` | [`array (EnvVar_v3)`](../objects/index.xml#io-k8s-api-core-v1-EnvVar_v3) | Args contains any build arguments that are to be passed to Docker. See <https://docs.docker.com/engine/reference/builder/#/arg> for more details |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`BuildRequest`](../workloads_apis/buildrequest-build-openshift-io-v1.xml#buildrequest-build-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`BuildRequest`](../workloads_apis/buildrequest-build-openshift-io-v1.xml#buildrequest-build-openshift-io-v1) schema |
| 201 - Created | [`BuildRequest`](../workloads_apis/buildrequest-build-openshift-io-v1.xml#buildrequest-build-openshift-io-v1) schema |
| 202 - Accepted | [`BuildRequest`](../workloads_apis/buildrequest-build-openshift-io-v1.xml#buildrequest-build-openshift-io-v1) schema |
