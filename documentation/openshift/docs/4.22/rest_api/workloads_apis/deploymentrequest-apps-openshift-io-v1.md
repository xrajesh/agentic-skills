...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`DeploymentRequest`](../workloads_apis/deploymentrequest-apps-openshift-io-v1.xml#deploymentrequest-apps-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DeploymentRequest`](../workloads_apis/deploymentrequest-apps-openshift-io-v1.xml#deploymentrequest-apps-openshift-io-v1) schema |
| 201 - Created | [`DeploymentRequest`](../workloads_apis/deploymentrequest-apps-openshift-io-v1.xml#deploymentrequest-apps-openshift-io-v1) schema |
| 202 - Accepted | [`DeploymentRequest`](../workloads_apis/deploymentrequest-apps-openshift-io-v1.xml#deploymentrequest-apps-openshift-io-v1) schema |
