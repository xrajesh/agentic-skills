...
| `template` | [`PodTemplateSpec`](../objects/index.xml#io-k8s-api-core-v1-PodTemplateSpec) | Template is the object that describes the pod that will be created if insufficient replicas are detected. |
...
| `resources` | [`ResourceRequirements_v2`](../objects/index.xml#io-k8s-api-core-v1-ResourceRequirements_v2) | Resources contains resource requirements to execute the deployment and any hooks. |
...
| `environment` | [`array (EnvVar_v2)`](../objects/index.xml#io-k8s-api-core-v1-EnvVar_v2) | Environment holds the environment which will be given to the container for Image. |
...
| `env` | [`array (EnvVar_v2)`](../objects/index.xml#io-k8s-api-core-v1-EnvVar_v2) | Env is a set of environment variables to supply to the hook pod’s container. |
...
| `to` | [`ObjectReference`](../objects/index.xml#io-k8s-api-core-v1-ObjectReference) | To is the target ImageStreamTag to set the container’s image onto. |
...
| `from` | [`ObjectReference`](../objects/index.xml#io-k8s-api-core-v1-ObjectReference) | From is a reference to an image stream tag to watch for changes. From.Name is the only required subfield - if From.Namespace is blank, the namespace of the current deployment trigger will be used. |
...
| Property | Type | Description |
|----|----|----|
| `from` | [`ObjectReference`](../objects/index.xml#io-k8s-api-core-v1-ObjectReference) | From is a reference to the changed object which triggered a deployment. The field may have the kinds DockerImage, ImageStreamTag, or ImageStreamImage. |
...
|----|----|
| 200 - OK | [`DeploymentConfigList`](../objects/index.xml#com-github-openshift-api-apps-v1-DeploymentConfigList) schema |
...
| Parameter | Type | Description |
|----|----|----|
| `body` | [`DeploymentConfig`](../workloads_apis/deploymentconfig-apps-openshift-io-v1.xml#deploymentconfig-apps-openshift-io-v1) schema |  |

Body parameters

| HTTP code | Reponse body |
|----|----|
| 200 - OK | [`DeploymentConfig`](../workloads_apis/deploymentconfig-apps-openshift-io-v1.xml#deploymentconfig-apps-openshift-io-v1) schema |
| 201 - Created | [`DeploymentConfig`](../workloads_apis/deploymentconfig-apps-openshift-io-v1.xml#deploymentconfig-apps-openshift-io-v1) schema |
| 202 - Accepted | [`DeploymentConfig`](../workloads_apis/deploymentconfig-apps-openshift-io-v1.xml#deploymentconfig-apps-openshift-io-v1) schema |
| 401 - Unauthorized | Empty |
