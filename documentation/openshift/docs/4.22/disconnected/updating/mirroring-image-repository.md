...
3.  If you use the [oc-mirror OpenShift CLI (`oc`) plugin](../../disconnected/updating/mirroring-image-repository.xml#mirroring-ocp-resources-ocmirror_mirroring-ocp-image-repository):
...
4.  If you use the [`oc adm release mirror` command](../../disconnected/updating/mirroring-image-repository.xml#update-mirror-repository-adm-release-mirror_mirroring-ocp-image-repository):
...
See [Mirroring images for a disconnected installation by using the oc-mirror plugin v2](../../disconnected/about-installing-oc-mirror-v2.xml#about-installing-oc-mirror-v2) for additional details.
