...
- [Configuring VMware vSphere features for control plane machines](../../../machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-supported-features-vsphere.xml#cpmso-supported-features-vsphere)
