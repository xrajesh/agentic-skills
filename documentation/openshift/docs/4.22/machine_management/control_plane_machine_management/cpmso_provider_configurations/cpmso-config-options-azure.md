...
- [Configuring Microsoft Azure features for control plane machines](../../../machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-supported-features-azure.xml#cpmso-supported-features-azure)
