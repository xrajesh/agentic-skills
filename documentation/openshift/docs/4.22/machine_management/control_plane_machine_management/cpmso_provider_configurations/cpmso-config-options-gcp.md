...
- [Configuring Google Cloud features for control plane machines](../../../machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-supported-features-gcp.xml#cpmso-supported-features-gcp)
