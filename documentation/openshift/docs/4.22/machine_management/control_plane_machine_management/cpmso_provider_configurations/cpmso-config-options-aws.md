...
- [Configuring Amazon Web Services features for control plane machines](../../../machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-supported-features-aws.xml#cpmso-supported-features-aws)
