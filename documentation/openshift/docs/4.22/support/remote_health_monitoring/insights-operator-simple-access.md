...
- [Using Red Hat subscriptions in builds](../../cicd/builds/running-entitled-builds.xml#builds-running-entitled-builds-with-sharedsecret-objects_running-entitled-builds)
