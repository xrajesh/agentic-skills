...
> [!NOTE]
> If you have a majority of your control plane nodes still available and have an etcd quorum, then [replace a single unhealthy etcd member](../../../backup_and_restore/control_plane_backup_and_restore/replacing-unhealthy-etcd-member.xml#replacing-unhealthy-etcd-member).
