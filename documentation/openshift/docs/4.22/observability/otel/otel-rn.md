...
The Red Hat build of OpenTelemetry 3.8 release adds the following features and enhancements:
...
The Red Hat build of OpenTelemetry 3.8 release adds the following Technology Preview features:
...
The Red Hat build of OpenTelemetry 3.8.2 patch release includes a fix for the following issue:
...
[TRACING-5678](https://issues.redhat.com/browse/TRACING-5678)
...
[TRACING-5590](https://issues.redhat.com/browse/TRACING-5590)
