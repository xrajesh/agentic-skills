...
- If you use OpenShift Virtualization: [Connecting a virtual machine to an SR-IOV network](../../virt/vm_networking/virt-connecting-vm-to-sriov.xml#virt-connecting-vm-to-sriov)
...
- [Ethernet network attachement: Adding a pod to an SR-IOV additional network](../../networking/hardware_networks/configuring-sriov-net-attach.xml#configuring-sriov-net-attach)

- [InfiniBand network attachement: Adding a pod to an SR-IOV additional network](../../networking/hardware_networks/configuring-sriov-ib-attach.xml#configuring-sriov-ib-attach)
