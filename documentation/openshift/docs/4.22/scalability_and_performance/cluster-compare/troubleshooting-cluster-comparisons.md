...
- [Installing the cluster-compare plugin](../../scalability_and_performance/cluster-compare/installing-cluster-compare-plugin.xml#installing-cluster-compare_installing-cluster-compare-plugin)

- [Configuring manual matching between CRs and templates](../../scalability_and_performance/cluster-compare/advanced-ref-config-customization.xml#cluster-compare-manual-match_advanced-ref-config-customization)
