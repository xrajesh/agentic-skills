...
- [Using Cluster Samples Operator image streams with alternate or mirrored registries](../openshift_images/samples-operator-alt-registry.xml#installation-restricted-network-samples_samples-operator-alt-registry)
