...
- [Creating the installation configuration file](../../../installing/installing_aws/ipi/installing-aws-localzone.xml#installation-generate-aws-user-infra-install-config_installing-aws-localzone)
