...
- To manage long-term cloud credentials manually, follow the procedure in [Manually creating long-term credentials](../../../installing/installing_azure/ipi/installing-azure-private.xml#manually-create-iam_installing-azure-private).

- To implement short-term credentials that are managed outside the cluster for individual components, follow the procedures in [Configuring an Azure cluster to use short-term credentials](../../../installing/installing_azure/ipi/installing-azure-private.xml#installing-azure-with-short-term-creds_installing-azure-private).
...
- For the list of permissions needed to create a private storage endpoint, see [Required Azure permissions for installer-provisioned infrastructure](../../../installing/installing_azure/installing-azure-account.xml#minimum-required-permissions-ipi-azure_installing-azure-account).
