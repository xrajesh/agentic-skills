...
<div id="additional-resources_updating-control-plane-only-update-console" role="_additional-resources" role="_additional-resources">
...
<div id="additional-resources_updating-control-plane-only-update-cli" role="_additional-resources" role="_additional-resources">
...
<div id="additional-resources_updating-control-plane-only-layered-products" role="_additional-resources" role="_additional-resources">
...
- [Performing a Control Plane Only update using the web console](../../updating/updating_a_cluster/control-plane-only-update.xml#updating-control-plane-only-update-console_control-plane-only-update)
