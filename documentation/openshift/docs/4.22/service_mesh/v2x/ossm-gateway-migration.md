...
- [Enabling gateway injection](../../service_mesh/v2x/ossm-traffic-manage.xml#ossm-automatic-gateway-injection_traffic-management)

- [Deploying automatic gateway injection](../../service_mesh/v2x/ossm-traffic-manage.xml#ossm-deploying-automatic-gateway-injection_traffic-management)
