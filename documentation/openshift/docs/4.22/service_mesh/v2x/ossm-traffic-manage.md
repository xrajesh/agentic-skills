...
For more information, see "Using wildcard routes" in [Ingress Operator in OpenShift Container Platform](../../networking/networking_operators/ingress-operator.xml#using-wildcard-routes).
...
This guide references the Bookinfo sample application to provide examples of routing in an example application. Install the [Bookinfo application](../../service_mesh/v2x/prepare-to-deploy-applications-ossm.xml#ossm-tutorial-bookinfo-overview_ossm-create-mesh) to learn how these routing examples work.
