...
- Read the [Preparing to install Red Hat OpenShift Service Mesh](../../service_mesh/v2x/preparing-ossm-installation.xml#preparing-ossm-installation) process.
...
- The Red Hat OpenShift Service Mesh Operator does not create the Service Mesh custom resource definitions (CRDs) until you deploy a Service Mesh control plane. You can use the `ServiceMeshControlPlane` resource to install and configure the Service Mesh components. For more information, see [Creating the ServiceMeshControlPlane](../../service_mesh/v2x/ossm-create-smcp.xml#ossm-create-smcp).
