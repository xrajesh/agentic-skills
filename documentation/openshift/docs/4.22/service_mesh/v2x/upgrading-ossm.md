...
For more information about upgrading Operators, refer to the [Operator Lifecycle Manager](../../operators/admin/olm-upgrading-operators.xml) documentation.
...
For more information about migrating your extensions, refer to [Migrating from ServiceMeshExtension to WasmPlugin resources](../../service_mesh/v2x/ossm-extensions.xml#ossm-extensions-migration-overview_ossm-extensions).
...
For information about mTLS, see [Enabling mutual Transport Layer Security (mTLS)](../../service_mesh/v2x/ossm-security.xml#ossm-security-mtls_ossm-security)
...
Some components support resource limiting and scheduling. For more information, see [Performance and scalability](../../service_mesh/v2x/ossm-performance-scalability.xml#ossm-performance-scalability).
