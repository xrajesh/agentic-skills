...
- [Specifying nodes for virtualization components](../../../virt/post_installation_configuration/virt-node-placement-virt-components.xml#virt-node-placement-virt-components)
