...
If you use the RHCOS trust bundle, place CA certificates in `/etc/pki/ca-trust/source/anchors`. For more information, see [Using shared system certificates](https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/10/html/securing_networks/using-shared-system-certificates) in the Red Hat Enterprise Linux (RHEL) *Securing networks* document.
