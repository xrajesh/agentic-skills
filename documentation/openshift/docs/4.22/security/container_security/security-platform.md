...
- [About admission plugins](../../architecture/admission-plug-ins.xml#admission-plug-ins)
...
- [SCC reference commands](../../authentication/managing-security-context-constraints.xml#security-context-constraints-command-reference_configuring-internal-oauth)

- [Examples of granting roles to service accounts](../../authentication/understanding-and-creating-service-accounts.xml#service-accounts-granting-roles_understanding-service-accounts)
