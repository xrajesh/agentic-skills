...
- You have taken an [etcd backup](../../backup_and_restore/control_plane_backup_and_restore/backing-up-etcd.xml#backup-etcd) in case you encounter any issues.
...
- [Replacing an unhealthy bare metal etcd member whose machine is not running or whose node is not ready](../../backup_and_restore/control_plane_backup_and_restore/replacing-unhealthy-etcd-member.xml#restore-replace-stopped-baremetal-etcd-member_replacing-unhealthy-etcd-member)
...
- [How to retrieve Master or Worker Ignition Configuration from OpenShift Container Platform 4? (Red Hat KCS article)](https://access.redhat.com/solutions/5504291)
