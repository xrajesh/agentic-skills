...
You can configure a certificate authority [to use with your scaled objects](../../nodes/cma/nodes-cma-autoscaling-custom-trigger-auth.xml#nodes-cma-autoscaling-custom-trigger-auth) or [for all scalers in the cluster](../../nodes/cma/nodes-cma-autoscaling-custom.xml#nodes-cma-autoscaling-custom-ca_nodes-cma-autoscaling-custom).
