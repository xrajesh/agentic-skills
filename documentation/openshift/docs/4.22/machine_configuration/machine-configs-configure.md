...
- [Enabling multipathing with kernel arguments on RHCOS](../installing/installing_bare_metal/upi/installing-bare-metal.xml#rhcos-enabling-multipath_installing-bare-metal)
