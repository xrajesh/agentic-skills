...
Kubernetes [objects](/docs/concepts/overview/working-with-objects/#kubernetes-objects "An entity in the Kubernetes system, representing part of the state of your cluster."). This document provides an overview of the different
...
See the [API reference](/docs/reference/generated/kubernetes-api/v1.34/)
