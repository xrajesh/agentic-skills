...
[Pods](/docs/concepts/workloads/pods/ "A Pod represents a set of running containers in your cluster.") are spread across your cluster
...
[workload](/docs/concepts/workloads/ "A workload is an application running on Kubernetes.")
...
domain(s) that each [node](/docs/concepts/architecture/nodes/ "A node is a worker machine in Kubernetes.") is in.
...
[`pods/topology-spread-constraints/one-constraint.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/topology-spread-constraints/one-constraint.yaml)![](/images/copycode.svg "Copy pods/topology-spread-constraints/one-constraint.yaml to clipboard")
...
[`pods/topology-spread-constraints/two-constraints.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/topology-spread-constraints/two-constraints.yaml)![](/images/copycode.svg "Copy pods/topology-spread-constraints/two-constraints.yaml to clipboard")
...
[`pods/topology-spread-constraints/one-constraint-with-nodeaffinity.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/topology-spread-constraints/one-constraint-with-nodeaffinity.yaml)![](/images/copycode.svg "Copy pods/topology-spread-constraints/one-constraint-with-nodeaffinity.yaml to clipboard")
