...
[`service/simple-service.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/simple-service.yaml)![](/images/copycode.svg "Copy service/simple-service.yaml to clipboard")
...
about the [Service API object](/docs/reference/generated/kubernetes-api/v1.34/#service-v1-core).
