...
An [EndpointSlice](/docs/concepts/services-networking/endpoint-slices/ "EndpointSlices track the IP addresses of Pods for Services.") can specify
...
[`service/networking/custom-dns.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/custom-dns.yaml)![](/images/copycode.svg "Copy service/networking/custom-dns.yaml to clipboard")
