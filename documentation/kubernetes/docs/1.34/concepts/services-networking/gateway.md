...
mechanism. [Gateway API](https://gateway-api.sigs.k8s.io/) is an [add-on](/docs/concepts/cluster-administration/addons/ "Resources that extend the functionality of Kubernetes.")
