...
* Service: A Kubernetes [Service](/docs/concepts/services-networking/service/ "A way to expose an application running on a set of Pods as a network service.") that identifies
  a set of Pods using [label](/docs/concepts/overview/working-with-objects/labels "Tags objects with identifying attributes that are meaningful and relevant to users.") selectors.
  Unless mentioned otherwise, Services are assumed to have virtual IPs only routable within the cluster network.

## What is Ingress?

[Ingress](/docs/reference/generated/kubernetes-api/v1.34/#ingress-v1-networking-k8s-io)
...
[`service/networking/minimal-ingress.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/minimal-ingress.yaml)![](/images/copycode.svg "Copy service/networking/minimal-ingress.yaml to clipboard")
...
* A backend is a combination of Service and port names as described in the
  ...
  by way of a [CRD](/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definitions/ "Custom code that defines a resource to add to your Kubernetes API server without building a complete custom server."). HTTP (and HTTPS) requests to the
...
[`service/networking/ingress-resource-backend.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/ingress-resource-backend.yaml)![](/images/copycode.svg "Copy service/networking/ingress-resource-backend.yaml to clipboard")
...
[`service/networking/ingress-wildcard-host.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/ingress-wildcard-host.yaml)![](/images/copycode.svg "Copy service/networking/ingress-wildcard-host.yaml to clipboard")
...
[`service/networking/external-lb.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/external-lb.yaml)![](/images/copycode.svg "Copy service/networking/external-lb.yaml to clipboard")
...
[`service/networking/default-ingressclass.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/default-ingressclass.yaml)![](/images/copycode.svg "Copy service/networking/default-ingressclass.yaml to clipboard")
...
[`service/networking/test-ingress.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/test-ingress.yaml)![](/images/copycode.svg "Copy service/networking/test-ingress.yaml to clipboard")
...
[`service/networking/simple-fanout-example.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/simple-fanout-example.yaml)![](/images/copycode.svg "Copy service/networking/simple-fanout-example.yaml to clipboard")
...
[`service/networking/name-virtual-host-ingress.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/name-virtual-host-ingress.yaml)![](/images/copycode.svg "Copy service/networking/name-virtual-host-ingress.yaml to clipboard")
...
[`service/networking/name-virtual-host-ingress-no-third-host.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/name-virtual-host-ingress-no-third-host.yaml)![](/images/copycode.svg "Copy service/networking/name-virtual-host-ingress-no-third-host.yaml to clipboard")
...
You can secure an Ingress by specifying a [Secret](/docs/concepts/configuration/secret/ "Stores sensitive information, such as passwords, OAuth tokens, and ssh keys.")
...
[`service/networking/tls-example-ingress.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/tls-example-ingress.yaml)![](/images/copycode.svg "Copy service/networking/tls-example-ingress.yaml to clipboard")
