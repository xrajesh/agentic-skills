...
* Application configured with appropriate [QoS class](/docs/concepts/workloads/pods/pod-qos/ "QoS Class (Quality of Service Class) provides a way for Kubernetes to classify pods within the cluster into several classes and make decisions about scheduling and eviction.")
...
Configure [Security Context](/docs/tasks/configure-pod-container/security-context/ "The securityContext field defines privilege and access control settings for a Pod or container.")
