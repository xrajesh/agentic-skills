...
[`controllers/nginx-deployment.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/controllers/nginx-deployment.yaml)![](/images/copycode.svg "Copy controllers/nginx-deployment.yaml to clipboard")
