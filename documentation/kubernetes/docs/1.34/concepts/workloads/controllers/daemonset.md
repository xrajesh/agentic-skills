...
[`controllers/daemonset.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/controllers/daemonset.yaml)![](/images/copycode.svg "Copy controllers/daemonset.yaml to clipboard")
...
The DaemonSet controller automatically adds a set of [tolerations](/docs/concepts/scheduling-eviction/taint-and-toleration/ "A core object consisting of three required properties: key, value, and effect. Tolerations enable the scheduling of pods on nodes or node groups that have a matching taint.") to DaemonSet Pods:
...
* Learn about [Pods](/docs/concepts/workloads/pods/):
  + Learn about [static Pods](/docs/tasks/configure-pod-container/static-pod/), which are useful for running Kubernetes
    [control plane](/docs/reference/glossary/?all=true#term-control-plane "The container orchestration layer that exposes the API and interfaces to define, deploy, and manage the lifecycle of containers.") components.
