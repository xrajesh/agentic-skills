...
[`controllers/frontend.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/controllers/frontend.yaml)![](/images/copycode.svg "Copy controllers/frontend.yaml to clipboard")
...
[`pods/pod-rs.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/pod-rs.yaml)![](/images/copycode.svg "Copy pods/pod-rs.yaml to clipboard")
...
[`controllers/hpa-rs.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/controllers/hpa-rs.yaml)![](/images/copycode.svg "Copy controllers/hpa-rs.yaml to clipboard")
