...
You can see the status of user namespaces support in cri-dockerd tracked in an [issue](https://github.com/Mirantis/cri-dockerd/issues/74)
on GitHub.
...
as [CVE-2021-25741](https://github.com/kubernetes/kubernetes/issues/104980), where a pod can potentially read arbitrary
...
* The binary `getsubids` installed (part of [shadow-utils](https://github.com/shadow-maint/shadow)) and
