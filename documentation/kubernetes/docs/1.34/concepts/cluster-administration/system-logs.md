...
For Kubernetes 1.34, this is gated behind the `ContextualLogging`
...
* The kubelet and [container runtime](/docs/setup/production-environment/container-runtimes "The container runtime is the software that is responsible for running containers.")
...
FEATURE STATE:
`Kubernetes v1.30 [beta]`(disabled by default)
