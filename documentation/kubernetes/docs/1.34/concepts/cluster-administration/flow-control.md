...
is a key task for cluster administrators. The [kube-apiserver](/docs/concepts/architecture/#kube-apiserver "Control plane component that serves the Kubernetes API.") has some controls available
...
[controller](/docs/concepts/architecture/controller/ "A control loop that watches the shared state of the cluster through the apiserver and makes changes attempting to move the current state towards the desired state.") need not
...
also involves an [API Group](/docs/concepts/overview/kubernetes-api/#api-groups-and-versioning "A set of related paths in the Kubernetes API.")
...
a technique known as [shuffle sharding](/docs/reference/glossary/?all=true#term-shuffle-sharding "A technique for assigning requests to queues that provides better isolation than hashing modulo the number of queues."), which makes relatively efficient use of
...
[PriorityLevelConfigurations](/docs/reference/generated/kubernetes-api/v1.34/#prioritylevelconfiguration-v1-flowcontrol-apiserver-k8s-io)
define the available priority levels, the share of the available concurrency
budget that each can handle, and allow for fine-tuning queuing behavior.
[FlowSchemas](/docs/reference/generated/kubernetes-api/v1.34/#flowschema-v1-flowcontrol-apiserver-k8s-io)
...
[`priority-and-fairness/health-for-strangers.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/priority-and-fairness/health-for-strangers.yaml)![](/images/copycode.svg "Copy priority-and-fairness/health-for-strangers.yaml to clipboard")
...
[`priority-and-fairness/list-events-default-service-account.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/priority-and-fairness/list-events-default-service-account.yaml)![](/images/copycode.svg "Copy priority-and-fairness/list-events-default-service-account.yaml to clipboard")
