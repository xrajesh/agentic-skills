...
[volumes](/docs/concepts/storage/volumes/ "A directory containing data, accessible to the containers in a pod.") into containers.
...
> [taints](/docs/concepts/scheduling-eviction/taint-and-toleration/ "A core object consisting of three required properties: key, value, and effect. Taints prevent the scheduling of pods on nodes or node groups.") itself as short on local storage
...
FEATURE STATE:
`Kubernetes v1.31 [beta]`(disabled by default)
