...
* [CSI ephemeral volumes](#csi-ephemeral-volumes):
  similar to the previous volume kinds, but provided by special [CSI](/docs/concepts/storage/volumes/#csi "The Container Storage Interface (CSI) defines a standard interface to expose storage systems to containers.") drivers
...
[parameters for a volume claim](/docs/reference/generated/kubernetes-api/v1.34/#ephemeralvolumesource-v1-core)
...
the [StorageClass](/docs/concepts/storage/storage-classes "A StorageClass provides a way for administrators to describe different available storage types.") uses immediate volume binding or when the Pod is
