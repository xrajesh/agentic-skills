...
[`configmap/configure-pod.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/configmap/configure-pod.yaml)![](/images/copycode.svg "Copy configmap/configure-pod.yaml to clipboard")
...
[`configmap/env-configmap.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/configmap/env-configmap.yaml)![](/images/copycode.svg "Copy configmap/env-configmap.yaml to clipboard")
