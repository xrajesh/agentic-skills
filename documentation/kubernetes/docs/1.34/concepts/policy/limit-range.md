...
[`concepts/policy/limit-range/problematic-limit-range.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/concepts/policy/limit-range/problematic-limit-range.yaml)![](/images/copycode.svg "Copy concepts/policy/limit-range/problematic-limit-range.yaml to clipboard")
