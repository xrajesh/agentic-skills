...
* Recruit for and advocate on behalf of SIG Docs with the [CNCF](https://cncf.io/ "Cloud Native Computing Foundation") and its platinum partners, including Google, Oracle, Azure, IBM, and Huawei
...
![Claiming the host role in Zoom](/images/docs/contribute/claim-host.png)
