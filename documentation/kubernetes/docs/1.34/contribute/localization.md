...
| Previous version | [`release-1.35`](https://github.com/kubernetes/website/tree/release-1.35) |
| Next version | [`dev-1.37`](https://github.com/kubernetes/website/tree/dev-1.37) |

The `main` branch holds content for the current release `v1.36`.
The release team creates a `release-1.36` branch before the next
release: v1.37.
