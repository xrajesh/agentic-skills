...
[Return to the regular view of this page](/docs/setup/production-environment/).

# Production environment

Create a production-quality Kubernetes cluster

* 1: [Container Runtimes](#pg-a77d3feb6e6d9978f32fa14622642e9a)
* 2: [Installing Kubernetes with deployment tools](#pg-00e1646f68aeb89f9722cf6f6cfcad94)

+ 2.1: [Bootstrapping clusters with kubeadm](#pg-a16f59f325a17cdeed324d5c889f7f73)

- 2.1.1: [Installing kubeadm](#pg-29e59491dd6118b23072dfe9ebb93323)
- 2.1.2: [Troubleshooting kubeadm](#pg-c3689df4b0c61a998e79d91a865aa244)
- 2.1.3: [Creating a cluster with kubeadm](#pg-134ed1f6142a98e6ac681a1ba4920e53)
- 2.1.4: [Customizing components with the kubeadm API](#pg-4c656c5eda3e1c06ad1aedebdc04a211)
- 2.1.5: [Options for Highly Available Topology](#pg-015edbc7cc688d31b1d1edce7c186135)
- 2.1.6: [Creating Highly Available Clusters with kubeadm](#pg-3941d5c3409342219bf7e03128b8ecb6)
- 2.1.7: [Set up a High Availability etcd Cluster with kubeadm](#pg-8160424c22d24f7d2d63c521e107dbf8)
- 2.1.8: [Configuring each kubelet in your cluster using kubeadm](#pg-07709e71de6b4ac2573041c31213dbeb)
- 2.1.9: [Dual-stack support with kubeadm](#pg-df2f3f20d404ebe2b03fcda1fcee50e7)

* 3: [Turnkey Cloud Solutions](#pg-d2f55eefe7222b7c637875af9c3ec199)
...
* *Availability*: A single-machine Kubernetes [learning environment](/docs/setup/#learning-environment)
  ...
  + Load balancing traffic to the cluster’s [API server](/docs/concepts/architecture/#kube-apiserver "Control plane component that serves the Kubernetes API.").
