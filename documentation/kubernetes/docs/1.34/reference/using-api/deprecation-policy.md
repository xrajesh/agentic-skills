...
| X+12 | v2, v2beta2 (deprecated), v2beta1 (deprecated), v1 (deprecated) | v1 | * v2beta2 is deprecated. See release notes for required actions. * v1 is deprecated in favor of v2, but will not be removed |
...
2. Adds a `"k8s.io/deprecated":"true"` annotation to the
