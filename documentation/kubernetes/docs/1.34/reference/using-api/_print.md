...
[Return to the regular view of this page](/docs/reference/using-api/).

# API Overview

* 1: [Declarative API Validation](#pg-55e3e828cf0a62d4d6cb59517678b254)
* 2: [Kubernetes API Concepts](#pg-2b5428a2ff6f4831fd972ef50e12b3eb)
* 3: [Server-Side Apply](#pg-040d9484db673074f1b8ba3465be9d91)
* 4: [Client Libraries](#pg-79880efc25dc8cb3b6962ad78a964319)
* 5: [Common Expression Language in Kubernetes](#pg-f0fd9899edb7b5a099fe73472c94f83b)
* 6: [Kubernetes Deprecation Policy](#pg-8d2ce3e7b2223cda0ccd428f4d5ea24b)
* 7: [Deprecated API Migration Guide](#pg-2479c39af50fd55b898a3bcfb5988077)
* 8: [Kubernetes API health endpoints](#pg-e4dbb59f8f23854d7b7d574e169923c4)
...
[API](/docs/reference/generated/kubernetes-api/v1.34/).

The [Kubernetes API reference](/docs/reference/generated/kubernetes-api/v1.34/)
lists the API for Kubernetes version v1.34.
...
* The named groups are at REST path `/apis/$GROUP_NAME/$VERSION` and use
  ...
  [Kubernetes API reference](/docs/reference/generated/kubernetes-api/v1.34/#-strong-api-groups-strong-).
