...
* **items** ([][ComponentStatus](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/component-status-v1/#ComponentStatus)), required
...
200 ([ComponentStatus](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/component-status-v1/#ComponentStatus)): OK
...
200 ([ComponentStatusList](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/component-status-v1/#ComponentStatusList)): OK
