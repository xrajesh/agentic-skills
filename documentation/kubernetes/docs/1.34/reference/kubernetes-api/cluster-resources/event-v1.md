...
* **regarding** ([ObjectReference](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/object-reference/#ObjectReference))

  regarding contains the object this Event is about. In most cases it's an Object reporting controller implements, e.g. ReplicaSetController implements ReplicaSets and this event is emitted because it acts on some changes in a ReplicaSet object.
* **related** ([ObjectReference](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/object-reference/#ObjectReference))
...
* **items** ([][Event](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/event-v1/#Event)), required
...
200 ([Event](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/event-v1/#Event)): OK
...
200 ([EventList](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/event-v1/#EventList)): OK
...
* **namespace** (*in path*): string, required
  ...
  [namespace](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-parameters/common-parameters/#namespace)
* **body**: [Event](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/event-v1/#Event), required
...
201 ([Event](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/event-v1/#Event)): Created

202 ([Event](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/cluster-resources/event-v1/#Event)): Accepted
