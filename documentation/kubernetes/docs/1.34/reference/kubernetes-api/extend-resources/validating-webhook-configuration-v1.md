...
* **webhooks** ([]ValidatingWebhook)
  ...
  *ValidatingWebhook describes an admission webhook and the resources and operations it applies to.*
  ...
  + **webhooks.namespaceSelector** ([LabelSelector](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/label-selector/#LabelSelector))
  ...
  + **webhooks.objectSelector** ([LabelSelector](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/label-selector/#LabelSelector))
...
* **items** ([][ValidatingWebhookConfiguration](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/extend-resources/validating-webhook-configuration-v1/#ValidatingWebhookConfiguration)), required
...
200 ([ValidatingWebhookConfiguration](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/extend-resources/validating-webhook-configuration-v1/#ValidatingWebhookConfiguration)): OK
...
200 ([ValidatingWebhookConfigurationList](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/extend-resources/validating-webhook-configuration-v1/#ValidatingWebhookConfigurationList)): OK
...
* **body**: [ValidatingWebhookConfiguration](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/extend-resources/validating-webhook-configuration-v1/#ValidatingWebhookConfiguration), required
...
201 ([ValidatingWebhookConfiguration](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/extend-resources/validating-webhook-configuration-v1/#ValidatingWebhookConfiguration)): Created

202 ([ValidatingWebhookConfiguration](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/extend-resources/validating-webhook-configuration-v1/#ValidatingWebhookConfiguration)): Accepted
