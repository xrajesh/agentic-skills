...
* **status** ([ResourceClaimStatus](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/workload-resources/resource-claim-v1/#ResourceClaimStatus))
    ...
    - **devices.requests.exactly** (ExactDeviceRequest)
      ...
      * **devices.requests.exactly.capacity** (CapacityRequirements)
        ...
        *CapacityRequirements defines the capacity requirements for a specific device request.*
        ...
        + **devices.requests.exactly.capacity.requests** (map[string][Quantity](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/quantity/#Quantity))
    ...
    - **devices.requests.firstAvailable** ([]DeviceSubRequest)
      ...
      * **devices.requests.firstAvailable.capacity** (CapacityRequirements)
        ...
        *CapacityRequirements defines the capacity requirements for a specific device request.*
        ...
        + **devices.requests.firstAvailable.capacity.requests** (map[string][Quantity](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/quantity/#Quantity))
    ...
    - **allocation.devices.results** ([]DeviceRequestAllocationResult)
      ...
      * **allocation.devices.results.bindingFailureConditions** ([]string)
        ...
        *Atomic: will be replaced during a merge*
        ...
        This is an alpha field and requires enabling the DRADeviceBindingConditions and DRAResourceClaimDeviceStatus feature gates.
      * **allocation.devices.results.consumedCapacity** (map[string][Quantity](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/quantity/#Quantity))
  ...
  + **allocation.nodeSelector** (NodeSelector)
    ...
    *A node selector represents the union of the results of one or more label queries over a set of nodes; that is, it represents the OR of the selectors represented by the node selector terms.*
    ...
    - **allocation.nodeSelector.nodeSelectorTerms** ([]NodeSelectorTerm), required
      ...
      * **allocation.nodeSelector.nodeSelectorTerms.matchExpressions** ([][NodeSelectorRequirement](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/node-selector-requirement/#NodeSelectorRequirement))

        *Atomic: will be replaced during a merge*

        A list of node selector requirements by node's labels.
      * **allocation.nodeSelector.nodeSelectorTerms.matchFields** ([][NodeSelectorRequirement](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-definitions/node-selector-requirement/#NodeSelectorRequirement))
...
* **items** ([][ResourceClaim](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/workload-resources/resource-claim-v1/#ResourceClaim)), required
...
200 ([ResourceClaim](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/workload-resources/resource-claim-v1/#ResourceClaim)): OK
...
200 ([ResourceClaimList](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/workload-resources/resource-claim-v1/#ResourceClaimList)): OK
...
* **namespace** (*in path*): string, required
  ...
  [namespace](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/common-parameters/common-parameters/#namespace)
* **body**: [ResourceClaim](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/workload-resources/resource-claim-v1/#ResourceClaim), required
...
201 ([ResourceClaim](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/workload-resources/resource-claim-v1/#ResourceClaim)): Created

202 ([ResourceClaim](https://v1-34.docs.kubernetes.io/docs/reference/kubernetes-api/workload-resources/resource-claim-v1/#ResourceClaim)): Accepted
