...
[`application/job/rabbitmq/worker.py`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/application/job/rabbitmq/worker.py)![](/images/copycode.svg "Copy application/job/rabbitmq/worker.py to clipboard")
...
[`application/job/rabbitmq/job.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/application/job/rabbitmq/job.yaml)![](/images/copycode.svg "Copy application/job/rabbitmq/job.yaml to clipboard")
