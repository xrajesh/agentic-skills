...
[`application/simple_deployment.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/application/simple_deployment.yaml)![](/images/copycode.svg "Copy application/simple_deployment.yaml to clipboard")
...
[`application/update_deployment.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/application/update_deployment.yaml)![](/images/copycode.svg "Copy application/update_deployment.yaml to clipboard")
