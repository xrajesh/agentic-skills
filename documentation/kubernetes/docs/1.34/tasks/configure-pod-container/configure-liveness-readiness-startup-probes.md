...
[`pods/probe/exec-liveness.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/probe/exec-liveness.yaml)![](/images/copycode.svg "Copy pods/probe/exec-liveness.yaml to clipboard")
...
[`pods/probe/http-liveness.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/probe/http-liveness.yaml)![](/images/copycode.svg "Copy pods/probe/http-liveness.yaml to clipboard")
...
[`pods/probe/tcp-liveness-readiness.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/probe/tcp-liveness-readiness.yaml)![](/images/copycode.svg "Copy pods/probe/tcp-liveness-readiness.yaml to clipboard")
...
[`pods/probe/grpc-liveness.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/probe/grpc-liveness.yaml)![](/images/copycode.svg "Copy pods/probe/grpc-liveness.yaml to clipboard")
...
[Probes](/docs/reference/generated/kubernetes-api/v1.34/#probe-v1-core)
...
* `failureThreshold`: After a probe fails `failureThreshold` times in a row, Kubernetes
  considers that the overall check has failed: the container is *not* ready/healthy/live.
...
[HTTP probes](/docs/reference/generated/kubernetes-api/v1.34/#httpgetaction-v1-core)
...
* `User-Agent`: The default value is `kube-probe/1.34`,
  where `1.34` is the version of the kubelet.
