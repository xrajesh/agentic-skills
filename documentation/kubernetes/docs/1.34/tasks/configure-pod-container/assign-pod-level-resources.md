...
For Kubernetes 1.34, resizing pod-level resources has the
...
[`pods/resource/pod-level-memory-request-limit.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/resource/pod-level-memory-request-limit.yaml)![](/images/copycode.svg "Copy pods/resource/pod-level-memory-request-limit.yaml to clipboard")
...
[`pods/resource/pod-level-cpu-request-limit.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/resource/pod-level-cpu-request-limit.yaml)![](/images/copycode.svg "Copy pods/resource/pod-level-cpu-request-limit.yaml to clipboard")
