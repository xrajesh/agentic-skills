...
If you are running [Minikube](/docs/tasks/tools/#minikube "A tool for running Kubernetes locally."), run the
...
Create a [Namespace](/docs/concepts/overview/working-with-objects/namespaces "An abstraction used by Kubernetes to support isolation of groups of resources within a single cluster.") so that the resources you
...
[`pods/resource/cpu-request-limit.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/resource/cpu-request-limit.yaml)![](/images/copycode.svg "Copy pods/resource/cpu-request-limit.yaml to clipboard")
...
[`pods/resource/cpu-request-limit-2.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/pods/resource/cpu-request-limit-2.yaml)![](/images/copycode.svg "Copy pods/resource/cpu-request-limit-2.yaml to clipboard")
