...
The `prefer-closest-numa-nodes` option is GA since Kubernetes 1.32. In Kubernetes 1.34
...
The `max-allowable-numa-nodes` option is beta since Kubernetes 1.31. In Kubernetes 1.34,
...
> lack of data, using this policy option with Kubernetes 1.34 is **not** recommended and is
> at your own risk.
