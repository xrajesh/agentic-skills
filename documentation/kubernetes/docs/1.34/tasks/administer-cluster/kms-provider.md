...
* Using Go: Use the functions and data structures in the stub file:
  [api.pb.go](https://github.com/kubernetes/kms/blob/release-1.34/apis/v1beta1/api.pb.go)
  to develop the gRPC server code
* Using languages other than Go: Use the protoc compiler with the proto file:
  [api.proto](https://github.com/kubernetes/kms/blob/release-1.34/apis/v1beta1/api.proto)
  to generate a stub file for the specific language

#### KMS v2

* Using Go: A high level
  [library](https://github.com/kubernetes/kms/blob/release-1.34/pkg/service/interface.go)
  ...
  [api.pb.go](https://github.com/kubernetes/kms/blob/release-1.34/apis/v2/api.pb.go)
  to develop the gRPC server code
* Using languages other than Go: Use the protoc compiler with the proto file:
  [api.proto](https://github.com/kubernetes/kms/blob/release-1.34/apis/v2/api.proto)
  to generate a stub file for the specific language
...
* KMS plugin version: `v2`
  ...
  compatible with the stable `v2` KMS API. Kubernetes 1.34 also supports the
...
3. `--encryption-provider-config-automatic-reload` boolean argument
