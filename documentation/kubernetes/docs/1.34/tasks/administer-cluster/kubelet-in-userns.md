...
without root privileges, by using a [user namespace](https://man7.org/linux/man-pages/man7/user_namespaces.7.html "A Linux kernel feature to emulate superuser privilege for unprivileged users.").
...
The first step is to create a [user namespace](https://man7.org/linux/man-pages/man7/user_namespaces.7.html "A Linux kernel feature to emulate superuser privilege for unprivileged users.").
