...
[`policy/zookeeper-pod-disruption-budget-minavailable.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/policy/zookeeper-pod-disruption-budget-minavailable.yaml)![](/images/copycode.svg "Copy policy/zookeeper-pod-disruption-budget-minavailable.yaml to clipboard")
...
[`policy/zookeeper-pod-disruption-budget-maxunavailable.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/policy/zookeeper-pod-disruption-budget-maxunavailable.yaml)![](/images/copycode.svg "Copy policy/zookeeper-pod-disruption-budget-maxunavailable.yaml to clipboard")
...
or with [custom resources](/docs/tasks/extend-kubernetes/custom-resources/custom-resource-definitions/ "Custom code that defines a resource to add to your Kubernetes API server without building a complete custom server.")
