...
[`application/wordpress/mysql-deployment.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/application/wordpress/mysql-deployment.yaml)![](/images/copycode.svg "Copy application/wordpress/mysql-deployment.yaml to clipboard")
...
[`application/wordpress/wordpress-deployment.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/application/wordpress/wordpress-deployment.yaml)![](/images/copycode.svg "Copy application/wordpress/wordpress-deployment.yaml to clipboard")
