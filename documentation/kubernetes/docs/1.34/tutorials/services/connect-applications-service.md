...
[`service/networking/run-my-nginx.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/run-my-nginx.yaml)![](/images/copycode.svg "Copy service/networking/run-my-nginx.yaml to clipboard")
...
[`service/networking/nginx-svc.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/nginx-svc.yaml)![](/images/copycode.svg "Copy service/networking/nginx-svc.yaml to clipboard")
...
Service).
View [Service](/docs/reference/generated/kubernetes-api/v1.34/#service-v1-core)
...
[labels](/docs/concepts/overview/working-with-objects/labels "Tags objects with identifying attributes that are meaningful and relevant to users.").
...
[CoreDNS cluster addon](https://releases.k8s.io/v1.34.0/cluster/addons/dns/coredns).
...
> the [pod spec](/docs/reference/generated/kubernetes-api/v1.36/#pod-v1-core).
...
[`service/networking/nginx-secure-app.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/nginx-secure-app.yaml)![](/images/copycode.svg "Copy service/networking/nginx-secure-app.yaml to clipboard")
...
[`service/networking/curlpod.yaml`](https://raw.githubusercontent.com/kubernetes/website/release-1.34/content/en/examples/service/networking/curlpod.yaml)![](/images/copycode.svg "Copy service/networking/curlpod.yaml to clipboard")
